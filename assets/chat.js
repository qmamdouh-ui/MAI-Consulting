...
var KB=[
 ...
 {id:"evidence",yes:true,rel:["article4","assessment-svc"],
  ...
  a:{en:"You leave with a scored baseline, your own approved policy, one page per department, a tool inventory, an attendance record and two scores, before and at 90 days. Together they form the file a donor, an auditor or a board asks to see.",
 ...
 {id:"small-groups",yes:true,rel:["training-svc","price","location"],
  ...
  a:{en:"Yes. Individuals and organisation representatives are served through courses for fewer than ten participants, in person or online, built on the participants’ own tasks and documents. Participants leave with one page for their work and an attendance record. Courses are priced per person, decreasing as the group grows. An in-person place starts at CHF 3,500 for one participant with one night included; accommodation and hospitality are charged at CHF 400 per person per night, and online courses carry no such charge. The estimator shows the per-person price for your group.",

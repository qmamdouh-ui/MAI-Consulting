...
var KB=[
 ...
 {id:"how-runs",yes:true,rel:["duration","contact","evidence"],
  ...
  a:{en:"Four steps. A 30-minute discovery call: what is already happening with AI in your organisation and which service you actually need, including none. Baseline: the assessment, plus interviews where the scope includes them. Delivery: policy drafted with your people, sessions built on your teams’ real tasks, agents and tools tested on your documents. Handover: a re-score, the evidence file and the cheatsheets in your hands. Engagements close with a capability you own.",

...
var KB=[
 ...
 {id:"small-groups",yes:true,rel:["training-svc","price","location"],
  ...
  a:{en:"Yes. Individuals and organisation representatives are served through courses for fewer than ten participants, in person or online, built on the participants’ own tasks and documents. Participants leave with one page for their work and an attendance record. Courses are priced per person, decreasing as the group grows; in-person courses include accommodation and hospitality arrangements at CHF 400 per person per night. The estimator shows the per-person price for your group.",
     fr:"Oui. Les particuliers et les représentants d’organisations sont servis par des cours de moins de dix participants, en présentiel ou en ligne, construits sur les tâches et les documents des participants. Chacun repart avec une page pour son travail et une attestation de présence. Les cours sont tarifés par personne, avec un prix dégressif selon la taille du groupe ; les cours en présentiel comprennent l’hébergement et l’accueil, à 400 CHF par personne et par nuit. L’estimateur affiche le prix par personne pour votre groupe.",
     ar:"نعم. نخدم الأفرادَ وممثّلي المؤسسات بدوراتٍ يقلّ عددُ المشاركين فيها عن عشرة، حضورياً أو عن بُعد، تُبنى على مهامّ المشاركين ووثائقهم. يخرج كلُّ مشارك بصفحةٍ واحدة لعمله وبسجلّ حضور. وتُسعَّر الدورات للفرد الواحد بسعرٍ يتناقص كلّما كبرت المجموعة، وتشمل الدوراتُ الحضورية الإقامةَ والضيافةَ بأربعمئة فرنك للشخص في الليلة. وتعرض حاسبةُ التقدير سعرَ الفرد لمجموعتكم."},

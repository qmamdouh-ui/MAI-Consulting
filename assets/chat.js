...
var KB=[
 ...
 {id:"training-svc",yes:true,rel:["cheatsheet","price","who-for"],
  ...
  a:{en:"Team AI Training is one organisation-wide session on the shared ground rules, then a 90-minute lab per department built on that department’s real tasks and real documents. Each lab ends with that team’s one-page cheatsheet. Teams of fewer than ten are served through small-group courses, in person or online. Two to six weeks depending on the number of departments. Teams of fewer than ten are served through small-group courses, in person or online.",
     fr:"La formation par équipe commence par une séance commune sur les règles partagées, puis un atelier de 90 minutes par département, construit sur ses tâches et ses documents réels. Chaque atelier se termine par la fiche pratique d’une page de l’équipe. Deux à six semaines selon le nombre de départements. Les équipes de moins de dix personnes sont servies par des cours en petit groupe, en présentiel ou en ligne.",
     ar:"يبدأ تدريب الفِرَق بجلسة واحدة لكل المؤسسة حول القواعد المشتركة، ثم ورشة من تسعين دقيقة لكل قسم، مبنيّة على مهامّه ووثائقه الحقيقية، وتنتهي كلّ ورشة بورقةٍ مرجعية من صفحة واحدة خاصّة بذلك الفريق. ويستغرق التدريب أسبوعين إلى ستة بحسب عدد الأقسام. أمّا الفِرَق التي يقلّ عددها عن عشرة فنخدمها بدوراتٍ لمجموعاتٍ صغيرة، حضورياً أو عن بُعد."},
 ...
 {id:"who-for",yes:true,rel:["private","funders","contact"],
  ...
  a:{en:"Mission-driven and international organisations of up to 500 staff (NGOs, foundations, UN agencies and public institutions), typically without an in-house AI function and with beneficiary, donor or personal data in their daily work. We speak first with the executive director or the data protection officer. Teams of fewer than ten are served through small-group courses, in person or online. Private-sector work is taken on referral.",
     fr:"Des organisations à mission et internationales jusqu’à 500 personnes (ONG, fondations, agences des Nations unies, institutions publiques), généralement sans fonction IA interne et qui manipulent des données de bénéficiaires, de bailleurs ou des données personnelles. Nous parlons d’abord à la direction ou au délégué à la protection des données. Les équipes de moins de dix personnes sont servies par des cours en petit groupe, en présentiel ou en ligne. Le secteur privé, sur recommandation uniquement.",
     ar:"نعمل مع المنظمات ذات الرسالة والمنظمات الدولية التي يعمل فيها حتى خمسمئة موظف: المنظمات غير الحكومية والمؤسسات ووكالات الأمم المتحدة والجهات العامة، ممّا لا وحدةَ ذكاءٍ اصطناعي داخلية لديه، ويتعامل يومياً مع بيانات المستفيدين أو المانحين أو البيانات الشخصية. ونخاطب أولاً المدير التنفيذي أو مسؤول حماية البيانات. أمّا الفِرَق التي يقلّ عددها عن عشرة أشخاص فنخدمها بدوراتٍ لمجموعاتٍ صغيرة، حضورياً أو عن بُعد. أمّا القطاع الخاص فنعمل معه بالتوصية فقط."},
 ...
 {id:"how-runs",yes:true,rel:["duration","contact","evidence"],
  ...
  a:{en:"Four steps. A 30-minute discovery call: what is happening with AI in your organisation and which service applies, if any. Baseline: the assessment, plus interviews where the scope includes them. Delivery: policy drafted with your people, sessions built on your teams’ real tasks, agents and tools tested on your documents. Handover: a re-score, the evidence file and the cheatsheets in your hands. Engagements close with a capability you own.",
 ...
 {id:"small-groups",yes:true,rel:["training-svc","price","location"],
  k:{"small team":7,"small group":7,"small-group":7,"small groups":7,"fewer than 10":7,"fewer than ten":7,"under 10":7,"less than 10":7,"less than ten":7,"under ten":7,"ten people":6,"five people":6,"six people":6,"eight people":6,"we are only":5,"tiny team":6,"in person":6,"in-person":6,"face to face":6,"face-to-face":6,"online course":5,"venue":5,"workshop for":4,"our team of":5,"team of three":8,"team of four":8,"team of five":8,"team of six":8,"team of seven":8,"team of eight":8,"team of nine":8,"team of 3":8,"team of 4":8,"team of 5":8,"team of 6":8,"team of 7":8,"team of 8":8,"team of 9":8,"just a few of us":6,"minimum size":6,"too small":7},
  kf:{"petite equipe":7,"moins de 10":7,"moins de dix":7,"en presentiel":7,"presentiel":7,"cours en presentiel":8,"equipe de cinq":8,"equipe de six":8,"equipe de quatre":8,"equipe de trois":8,"en ligne":4,"petit groupe":7,"petits groupes":7,"salle":4,"trop petit":7,"trop petite":7,"nous sommes cinq":6,"nous sommes six":6,"taille minimale":6},
  ka:{"فريق صغير":7,"فريقنا صغير":7,"اقل من عشرة":7,"اقل من 10":7,"مجموعة صغيرة":7,"مجموعات صغيرة":7,"حضوري":6,"حضوريا":6,"وجاهي":6,"عن بعد":4,"اونلاين":4,"قاعة":4,"صغيرة جدا":6,"الحد الادنى":6,"خمسة اشخاص":6,"عشرة اشخاص":6},
  a:{en:"Yes. Teams of fewer than ten are served through small-group courses, in person or online, built on the team’s own tasks and documents. Participants leave with one page for their work and the organisation holds an attendance record. For in-person courses we arrange the venue and the participants’ logistics, quoted with the course. The estimator’s smallest band gives the indicative price.",
     fr:"Oui. Les équipes de moins de dix personnes sont servies par des cours en petit groupe, en présentiel ou en ligne, construits sur les tâches et les documents de l’équipe. Les participants repartent avec une page pour leur travail et l’organisation conserve un registre de présence. Pour les cours en présentiel, nous organisons la salle et la logistique des participants, chiffrées avec le cours. La plus petite tranche de l’estimateur donne le prix indicatif.",
     ar:"نعم. نخدم الفِرَق التي يقلّ عددها عن عشرة أشخاص بدوراتٍ لمجموعاتٍ صغيرة، حضورياً أو عن بُعد، تُبنى على مهامّ الفريق ووثائقه. يخرج المشاركون بصفحةٍ واحدة لعملهم، وتحتفظ المؤسسة بسجلّ حضور. وفي الدورات الحضورية نتولّى ترتيب القاعة ولوجستيات المشاركين، وتُسعَّر مع الدورة. وتعطي أصغرُ فئةٍ في حاسبة التقدير السعرَ التقريبي."},
  l:"estimate/?preset=training&size=s1",t:{en:"Price a small-group course",fr:"Estimer un cours en petit groupe",ar:"قدّر تكلفة دورة لمجموعة صغيرة"}},
